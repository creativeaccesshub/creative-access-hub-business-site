...
const CONTACT_CONFIG = {
    WHATSAPP_NUMBER: '919080965883',
    INSTAGRAM_URL: 'https://www.instagram.com/creativeaccesshub/',
    FACEBOOK_URL: 'https://www.facebook.com/profile.php?id=61586036129294',
    EMAIL: 'creativeaccesshub@gmail.com'
};

// WhatsApp integration
function contactViaWhatsApp(planType) {
    const price = planType === 'Standard' ? '3,000' : '3,350';
    const message = `Hi Creative Access! I'm interested in the ${planType} Adobe Creative Cloud plan (₹${price}). Can you provide more details and process my order?`;
    openWhatsApp(message);
}

function openWhatsApp(message = '') {
    const defaultMsg = "Hi! I'm interested in Adobe Creative Cloud plans from Creative Access. Can you help me?";
...
function buyNow(planType) {
    const price = planType === 'Standard' ? '3,000' : '3,350';
    const message = `Hi Creative Access! I want to buy the ${planType} plan (₹${price}). How can I proceed with the payment?`;
